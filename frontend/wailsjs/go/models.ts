export namespace main {
	...
	export class DependencyAnalysis {
	    ...
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.order = this.convertValues(source["order"], DependencyNode);
	        this.hasCycle = source["hasCycle"];
	        this.cycleNames = source["cycleNames"];
	        this.selfRefNames = source["selfRefNames"];
	    }
